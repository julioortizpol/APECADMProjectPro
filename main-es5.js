(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AttachfiledialogComponent = /** @class */ (function () {
                function AttachfiledialogComponent(dialogRef) {
                ...
                AttachfiledialogComponent.prototype.ngOnInit = function () {
                };
                AttachfiledialogComponent.prototype.submit = function () {
                    if (this.addfileForm.invalid) {
                        return;
                    }
                    this.dialogRef.close();
                };
                return AttachfiledialogComponent;
            }());
            AttachfiledialogComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AsignAdmsProyectDialogComponent = /** @class */ (function () {
                function AsignAdmsProyectDialogComponent(dialogRef) {
                    this.dialogRef = dialogRef;
                    this.condition = false;
                    this.usersData = [];
                }
                AsignAdmsProyectDialogComponent.prototype.ngOnInit = function () {
                ...
                return AsignAdmsProyectDialogComponent;
            }());
            AsignAdmsProyectDialogComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateProyectComponent = /** @class */ (function () {
                function CreateProyectComponent(dialogRef, asignadmsproyectDialog) {
                    this.dialogRef = dialogRef;
                ...
                CreateProyectComponent.prototype.submit = function () {
                    if (this.newProyectFrom.invalid) {
                        return;
                    }
                    this.dialogRef.close();
                };
                CreateProyectComponent.prototype.openasignadmsproyectDialog = function () {
                    var dialogRef = this.asignadmsproyectDialog.open(_create_proyect_asign_adms_proyect_dialog_asign_adms_proyect_dialog_component__WEBPACK_IMPORTED_MODULE_4__["AsignAdmsProyectDialogComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var CreatenewuserdialogComponent = /** @class */ (function () {
                function CreatenewuserdialogComponent() {
                }
                return CreatenewuserdialogComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var FilehistorydialogComponent = /** @class */ (function () {
                function FilehistorydialogComponent() {
                }
                FilehistorydialogComponent.prototype.ngOnInit = function () {
                };
                return FilehistorydialogComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HeaderComponent = /** @class */ (function () {
                function HeaderComponent(router, createProyectComponent) {
                    var _this = this;
                    this.router = router;
                ...
                HeaderComponent.prototype.opencreateProyectComponent = function () {
                    var dialogRef = this.createProyectComponent.open(_create_proyect_create_proyect_component__WEBPACK_IMPORTED_MODULE_4__["CreateProyectComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                    });
                };
                ...
                HeaderComponent.prototype.setFocusTabWithTheUrl = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var HumanresourceComponent = /** @class */ (function () {
                function HumanresourceComponent(HumanresourceDialog, userDetailDialog, router) {
                ...
                HumanresourceComponent.prototype.ngOnInit = function () {
                    if (this.router.url == "/mainpage/personal") {
                        this.elementVisible = true;
                    }
                    this.users = _staticData_userData__WEBPACK_IMPORTED_MODULE_2__["userdata"];
                };
                HumanresourceComponent.prototype.openAddUserDialog = function () {
                    var dialogRef = this.HumanresourceDialog.open(_createnewuserdialog_createnewuserdialog_component__WEBPACK_IMPORTED_MODULE_4__["CreatenewuserdialogComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                    });
                };
                HumanresourceComponent.prototype.openUserDetailDialog = function () {
                    var dialogRef = this.userDetailDialog.open(_humanresource_usersdetail_usersdetail_component__WEBPACK_IMPORTED_MODULE_5__["UsersdetailComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                    });
                };
                return HumanresourceComponent;
            }());
            HumanresourceComponent.ctorParameters = function () { return [
                { type: _angular_mdc_web__WEBPACK_IMPORTED_MODULE_3__["MdcDialog"] },
                { type: _angular_mdc_web__WEBPACK_IMPORTED_MODULE_3__["MdcDialog"] },
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ForgotPasswordDialogComponent = /** @class */ (function () {
                function ForgotPasswordDialogComponent(dialogRef) {
                    this.dialogRef = dialogRef;
                ...
                ForgotPasswordDialogComponent.prototype.submit = function () {
            ...
            ForgotPasswordDialogComponent.ctorParameters = function () { return [
                { type: _angular_mdc_web__WEBPACK_IMPORTED_MODULE_2__["MdcDialogRef"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(forgotPasworrdDialogC, stateOfSendRequest, router) {
                ...
                LoginComponent.prototype.openForgotPaswordDialog = function () {
                    var _this = this;
                    var dialogRef = this.forgotPasworrdDialogC.open(_forgot_password_dialog_forgot_password_dialog_component__WEBPACK_IMPORTED_MODULE_3__["ForgotPasswordDialogComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                        if (reason != "close") {
                            _this.simple();
                        }
                ...
                LoginComponent.prototype.simple = function () {
                    var snackbarRef = this.stateOfSendRequest.open('Your going to recive and Mail with the next steps');
                    snackbarRef.afterDismiss().subscribe(function (reason) {
                        console.log(reason);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MytaskComponent = /** @class */ (function () {
                function MytaskComponent(taskDetailDialog, router, createtaskDialog) {
                ...
                MytaskComponent.prototype.openTaskDetailDialog = function () {
                    var dialogRef = this.taskDetailDialog.open(_taskdetaildialog_taskdetaildialog_component__WEBPACK_IMPORTED_MODULE_3__["TaskdetaildialogComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                    });
                };
                MytaskComponent.prototype.openCreateTaskDialog = function () {
            ...
            MytaskComponent.ctorParameters = function () { return [
                { type: _angular_mdc_web__WEBPACK_IMPORTED_MODULE_2__["MdcDialog"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_5__["Router"] },
                { type: _angular_mdc_web__WEBPACK_IMPORTED_MODULE_2__["MdcDialog"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var ProyectdetailinfoComponent = /** @class */ (function () {
                function ProyectdetailinfoComponent() {
                }
                ProyectdetailinfoComponent.prototype.ngOnInit = function () {
                };
                return ProyectdetailinfoComponent;
            }());
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            var ProyectdetailsComponent = /** @class */ (function () {
                function ProyectdetailsComponent(router) {
                    this.router = router;
                }
                ProyectdetailsComponent.prototype.ngOnInit = function () {
                    this.router.navigate(['/mainpage/detalleproyecto/tareas']);
                };
                return ProyectdetailsComponent;
            }());
            ProyectdetailsComponent.ctorParameters = function () { return [
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProyectsComponent = /** @class */ (function () {
                function ProyectsComponent(createProyectComponent) {
                    this.createProyectComponent = createProyectComponent;
                }
                ProyectsComponent.prototype.ngOnInit = function () {
                };
                ProyectsComponent.prototype.opencreateProyectComponent = function () {
                    var dialogRef = this.createProyectComponent.open(_create_proyect_create_proyect_component__WEBPACK_IMPORTED_MODULE_2__["CreateProyectComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TaskdetaildialogComponent = /** @class */ (function () {
                function TaskdetaildialogComponent(attachfiledialog, doclife) {
                ...
                TaskdetaildialogComponent.prototype.ngOnInit = function () {
                ...
                TaskdetaildialogComponent.prototype.logTab = function (event) {
                    if (event.index == 0) {
                ...
                TaskdetaildialogComponent.prototype.openattachfiledialog = function () {
                    var dialogRef = this.attachfiledialog.open(_attachfiledialog_attachfiledialog_component__WEBPACK_IMPORTED_MODULE_4__["AttachfiledialogComponent"]);
                    dialogRef.afterClosed().subscribe(function (reason) {
                    });
                };
                TaskdetaildialogComponent.prototype.openfilehistorydialog = function () {
                    this.doclife.open(_filehistorydialog_filehistorydialog_component__WEBPACK_IMPORTED_MODULE_5__["FilehistorydialogComponent"]);
                };
                return TaskdetaildialogComponent;
            }());
            TaskdetaildialogComponent.ctorParameters = function () { return [
